        ...
        <a class="nav-link dropdown-toggle gap-0" role="button" data-bs-toggle="dropdown" aria-expanded="false" href="#">
            <div class="d-inline-flex p-0 align-items-center ">
                ...
                <div class="d-inline-flex flex-column p-2">
                    <p class="m-0">${usuario.nombre}</p>
                    <p class="m-0">${usuario.gmail}</p>
                </div>
            </div>
        </a>
        <ul class="dropdown-menu bg-dark gap-0 p-0">                            
            <button id="btnIngresar" type="button" class="btn btn-warning" onclick="cerrarSesion()">
                Cerrar Sesion
            </button>
        </ul>
    `;
